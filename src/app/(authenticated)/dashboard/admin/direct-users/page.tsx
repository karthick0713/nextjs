...
export default function AdminDirectUsersManagementPage() {
      ...
      <div className="space-y-6">
        ...
        <CardHeader className="pb-4 px-4 sm:px-6">
          <div className="flex justify-between items-center">
            <div>
              <CardTitle className="text-lg sm:text-xl font-semibold">Manage Direct Users</CardTitle>
              <CardDescription>
                View and manage direct users
              </CardDescription>
            </div>
