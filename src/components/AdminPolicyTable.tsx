...
import AdminPolicyDetailsCard from './AdminPolicyDetailsCard';
...
const AdminPolicyTable: React.FC<PolicyTableProps> = ({
  policies,
  onPageChange,
  onSearchChange,
  onEntriesChange,
        ...
        <Table>
          ...
          <TableBody>
            {policies.map((policy, index) => (
              <TableRow key={policy.policynumnew}>
                <TableCell>{startEntry + index}</TableCell>
                <TableCell>{policy.policynumnew}</TableCell>
                <TableCell>{policy.firstname1 + ' ' + policy.lastname1}</TableCell>
                <TableCell>{policy.email}</TableCell>
                <TableCell>$ {(policy.premium/100).toFixed(2)}</TableCell>
                <TableCell>{policy.insurance_file || '-'}</TableCell>
                <TableCell>
